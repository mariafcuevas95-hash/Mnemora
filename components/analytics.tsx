...
/**
 * PostHog analytics — carga después de la interacción (afterInteractive).
 * No bloquea la página. No se monta si NEXT_PUBLIC_POSTHOG_KEY está ausente.
 * Sin npm package: PostHog se carga via CDN en prod.
 */
