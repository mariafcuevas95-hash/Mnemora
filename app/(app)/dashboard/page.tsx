      ...
      <div className="mn-fade-up" style={{ marginBottom: 8, animationDelay: "400ms" }}>
        ...
        {!loaded ? (
          ...
          <div className="mn-card" style={{ padding: 32, textAlign: "center", boxShadow: "var(--mn-shadow-sm)" }}>
            ...
            <p className="font-display" style={{ fontSize: 16, fontWeight: 800, color: "var(--mn-ink-1)", marginBottom: 8 }}>
              Todavía no tienes materias
            </p>
            <p style={{ fontSize: 14, color: "var(--mn-ink-2)", marginBottom: 20, lineHeight: 1.6 }}>
              Sube un documento y empiezo a trabajar.
            </p>
            <Link href="/onboarding" className="mn-btn-primary" style={{ fontSize: 14 }}>
              Agregar materia →
            </Link>
          </div>
        ) : (
