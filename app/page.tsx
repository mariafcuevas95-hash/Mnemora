      ...
      <div style={{ maxWidth: 1120, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20, maxWidth: 980, margin: "0 auto" }}>
          ...
          <div className="mn-card" style={{ padding: 32, background: "#1B3F2F", border: "none", position: "relative", overflow: "hidden" }}>
            ...
            <Link href="/registro" style={{ display: "block", textAlign: "center", padding: "14px", borderRadius: 12, background: "#FFFFFF", fontSize: 15, fontWeight: 700, color: "#1B3F2F", textDecoration: "none" }}>
          ...
          <div className="mn-card" style={{ padding: 32, background: "#0F0A04", border: "none", position: "relative", overflow: "hidden" }}>
            ...
            <Link href="/registro" style={{ display: "block", textAlign: "center", padding: "14px", borderRadius: 12, background: "var(--mn-green)", fontSize: 15, fontWeight: 700, color: "#fff", textDecoration: "none" }}>
