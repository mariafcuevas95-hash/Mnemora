...
// Checkout URLs — set in Vercel env vars, never hardcode
const CHECKOUT_PRO_MONTHLY     = process.env.NEXT_PUBLIC_HOTMART_CHECKOUT_PRO_MONTHLY     ?? "";
const CHECKOUT_PRO_ANNUAL      = process.env.NEXT_PUBLIC_HOTMART_CHECKOUT_PRO_ANNUAL      ?? "";
const CHECKOUT_PREMIUM_MONTHLY = process.env.NEXT_PUBLIC_HOTMART_CHECKOUT_PREMIUM_MONTHLY ?? "";
const CHECKOUT_PREMIUM_ANNUAL  = process.env.NEXT_PUBLIC_HOTMART_CHECKOUT_PREMIUM_ANNUAL  ?? "";
